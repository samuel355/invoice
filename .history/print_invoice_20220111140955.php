...
$output .= '<table width="100%" border="1" cellpadding="5" cellspacing="0">
	<tr>
	<td colspan="2" align="center" style="font-size:18px"><b>OFFICIAL INVOICE</b></td>
	</tr>
	<tr>
		<td colspan="2" align="right">
			<img width="50px" height="50px" style="" src="L.H.C. Logo" alt="">
		</td>
	</tr>
	<tr>
	<td colspan="2">
...
$invoiceFileName = 'LHC_'.$invoiceValues['order_id'].'.pdf';
require_once 'dompdf/src/Autoloader.php';
Dompdf\Autoloader::register();
use Dompdf\Dompdf;
$dompdf = new Dompdf();
$dompdf->loadHtml(html_entity_decode($output));
$dompdf->setPaper('A4', 'por');
$dompdf->render();
